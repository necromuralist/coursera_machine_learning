...
I created some classes to make it easier to handle the code. It's excessive to use a base-class here, but in the original lesson I had a third class for the SFrame so it and the class for the DataFrame had a lot of shared code.
...
.. currentmodule:: machine_learning.coursera.regression.week_3.regression_model
.. autosummary::
   :toctree: api

   BaseRegressionModel

.. currentmodule:: machine_learning.coursera.regression.week_3.regression_model.BaseRegressionModel
.. autosummary::
   :toctree: api
...
.. uml::
   ...
   BaseRegressionModel <|-- FrameRegressionModel
...
.. currentmodule:: machine_learning.coursera.regression.week_3.regression_model.FrameRegressionModel
.. autosummary::
   :toctree: api
